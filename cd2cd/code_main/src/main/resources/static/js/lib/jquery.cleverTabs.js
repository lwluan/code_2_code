...
CleverTabs.prototype.setupContextMenu = function () {
    ...
    if (!self.options.contextMenu) {
        contextMenu = {
            element: $('<ul class="list-group" id="cleverTabsContextMenu">'
        + '<li class="list-group-item" id="mnuEnabl" ><a href="#enabled"><span class="glyphicon glyphicon-ok-circle" style="float: left; margin-right: 5px;"></span>Enable</a></li>'
        + '<li class="list-group-item" id="mnuDisalb"><a href="#disable"><span class="glyphicon glyphicon-ban-circle" style="float: left; margin-right: 5px;"></span>Disable</a></li>'
        + '<li class="list-group-item" id="mnuLock" ><a href="#lock"><span class="glyphicon glyphicon-lock" style="float: left; margin-right: 5px;"></span>Lock</a></li>'
        + '<li class="list-group-item" id="mnuUnlock"><a href="#unlock"><span class="ui-icon ui-icon-unlocked" style="float: left; margin-right: 5px;"></span>Unlock</a></li>'
        + '<li class="list-group-item" id="mnuRefresh" ><a href="#refresh"><span class="glyphicon glyphicon-refresh" style="float: left; margin-right: 5px;"></span>Refresh</a></li>'
        + '<li class="list-group-item" id="mnuCloseAll"><a href="#clear"><span class="glyphicon glyphicon-remove" style="float: left; margin-right: 5px;"></span>Close All</a></li>'
        + '</ul>'),
...
CleverTab.prototype.setLock = function (lock, changeOrgLock) {
    ...
    if (!lock) {
        ...
        var btnClose = $('<a href="javascript:void(0)" class="ui-corner-all" title="Close" style="position: absolute; cursor: pointer; padding: 0px; top: 1px; right: 5px"><i class="glyphicon glyphicon-remove"></i></a>');
